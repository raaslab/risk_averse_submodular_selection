...
% 1, presample 
% n_samp = 1000; 
% goalroutes_effi_samp = presample_gaussian(goalroutes_length, goalroutes_length, n_samp);
...
%     routes_effi_samp_temp = routes_effi_samp; 
...
%         cvar_gre_distri
        ...
        %update the D_temp, R_temp r_node_temp, d_node_temp, ...
        % routes_length_temp, routes_degree_temp
...
%             = update_parameter_allstep(d_nodes_act, r_nodes_act, r_nodes_full, cvar_greset, greset_full,...
%             greset_update, allnodes, goalroutes, goalroutes_length, goalroutes_degree,...
%             ve_edge_de, ve_edge_de_last, edges_length_degree);
       
        % update min_next
        [d_nodes_act, r_nodes_act, r_nodes_full, ve_edge_de, ve_edge_de_last,...
            routes_length_temp, routes_degree_temp, greset_full, greset_update, reach_next_time]...
            = update_parameter_allstep_minnext(d_nodes_act, r_nodes_act, r_nodes_full, cvar_greset, greset_full,...
            greset_update, allnodes, goalroutes, goalroutes_length, goalroutes_degree,...
            ve_edge_de, ve_edge_de_last, edges_length_degree);  
...
%           [d_nodes_act, r_nodes_act, r_nodes_full, ve_edge_de, ve_edge_de_last,...
%               routes_length_temp, routes_degree_temp, greset_full, greset_update, reach_next_time]...
%               = update_parameter_allstep_minnext2(d_nodes_act, r_nodes_act, r_nodes_full, cvar_greset, greset_full,...
%               greset_update, allnodes, goalroutes, goalroutes_length, goalroutes_degree,...
%               ve_edge_de, ve_edge_de_last, edges_length_degree, reach_next_time);  
