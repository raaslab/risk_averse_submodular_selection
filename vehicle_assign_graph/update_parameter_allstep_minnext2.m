...
function [d_nodes_1, r_nodes_1, rnodes_full_1, ve_edge_de_1, ve_edge_de_last_1,...
    routes_length, routes_degree, greset_full_1, greset_update_1, min_reach_next_time_1]...
            = update_parameter_allstep_minnext2(d_nodes, r_nodes, rnodes_full, cvar_set, ...
            greset_full, greset_update, allnodes, goalroutes, goalroutes_length, ...
            goalroutes_degree, ve_edge_de, ve_edge_de_last, edges_length_degree, min_reach_next_time)  
