...
function [d_nodes_1, r_nodes_1, ve_edge_de_1, ve_edge_de_last_1, min_reach_next_time]...
            = update_parameter_offline_minnext(d_nodes, r_nodes, cvar_set,...
...
%          reach_demand_j = zeros(length(r_nodes_1(:,1)),1); 
         ...
         min_reach_next_time =10000; % initial, waiting for update
         for i = 1 : length(d_nodes(:,1))
             ...
             for j = 1 : length(cvar_set{d_2_inx})
                ...
                ve_edge_de_last_1{d_nodes(i,1), r_nodes(cvar_set{d_2_inx}(j),1)}...
